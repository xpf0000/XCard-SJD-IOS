...
class MyOrderSendingVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://api.0539cn.com/index.php?c=Order&a=orderList&mob=\(UMob)&identify=\(UIdentify)&nowpage=[page]&perpage=20&status=1"
        
        table.setHandle(url, pageStr: "[page]", keys: ["datas"], model: OrderModel.self, CellIdentifier: "MyOrderSendingCell")
        
        table.show()
        
//        table.setHandle("", pageStr: "", keys: ["data"], model: OrderModel.self, CellIdentifier: "MyOrderSendingCell")
//        
//        for _ in 0...5
//        {
//            let m = OrderModel()
