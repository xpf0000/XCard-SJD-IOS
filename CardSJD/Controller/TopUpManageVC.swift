...
class TopUpManageVC: UITableViewController {
    ...
    func showChart()
    {
        ...
        //let labelSettingY = ChartLabelSettings(font: ExamplesDefaults.labelFont)
        
        let labelSettingY = ChartLabelSettings(font: ExamplesDefaults.labelFont, fontColor: UIColor.clearColor())
