...
class MyOrderSendingCell: UITableViewCell,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func setSelected(selected: Bool, animated: Bool) {
        ...
        if selected
        {
            ...
            let vc = "MyOrderSendingInfoVC".VC("Main") as! MyOrderSendingInfoVC
