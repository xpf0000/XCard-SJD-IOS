...
class MyOrderEndedVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://api.0539cn.com/index.php?c=Order&a=orderList&mob=\(UMob)&identify=\(UIdentify)&nowpage=[page]&perpage=20&status=2"
        
        table.setHandle(url, pageStr: "[page]", keys: ["datas"], model: OrderModel.self, CellIdentifier: "MyOrderEndedCell")
        
        table.show()
        
//        table.setHandle("", pageStr: "", keys: ["data"], model: OrderModel.self, CellIdentifier: "MyOrderEndedCell")
//        
//        for _ in 0...5
//        {
//            let m = OrderModel()
