...
class MyRecordVC2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://api.0539cn.com/index.php?c=User&a=getFreez&mob=\(UMob)&identify=\(UIdentify)&nowpage=[page]&perpage=20"
        
        table.setHandle(url, pageStr: "[page]", keys: ["datas"], model: CashFlowRecordModel.self, CellIdentifier: "MyRecordCell1")
