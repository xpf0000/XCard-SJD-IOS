...
class MyOrderEndedCell: UITableViewCell,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func setSelected(selected: Bool, animated: Bool) {
        ...
        if selected
        {
            ...
            let vc = "MyOrderEndedInfoVC".VC("Main") as! MyOrderEndedInfoVC
