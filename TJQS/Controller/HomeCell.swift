...
class HomeCell: UITableViewCell,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    @IBAction func leftClick(sender: UIButton) {
        ...
        let url = "http://api.0539cn.com/index.php?c=Order&a=cancelOrder&mob=\(UMob)&identify=\(UIdentify)&id=\(model.id)"
    ...
    @IBAction func rightClick(sender: UIButton) {
        ...
        let url = "http://api.0539cn.com/index.php?c=Order&a=grabOrder&mob=\(UMob)&identify=\(UIdentify)&id=\(model.id)"
    ...
    override func setSelected(selected: Bool, animated: Bool) {
        ...
        if selected
        {
            ...
            let vc = "WaitOrderInfoVC".VC("Main") as! WaitOrderInfoVC
