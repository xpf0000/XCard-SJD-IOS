...
public enum NVActivityIndicatorType:Int {
    ...
    static let allValues = [Blank, BallPulse, BallGridPulse,BallClipRotate,SquareSpin,BallClipRotatePulse,BallClipRotateMultiple,BallPulseRise,BallRotate,CubeTransition,BallZigZag,BallZigZagDeflect,BallTrianglePath,BallScale,LineScale,LineScaleParty,BallScaleMultiple,BallPulseSync,BallBeat,LineScalePulseOut,LineScalePulseOutRapid,BallScaleRipple,BallScaleRippleMultiple,BallSpinFadeLoader,LineSpinFadeLoader,TriangleSkewSpin,Pacman,BallGridBeat,SemiCircleSpin,BallRotateChase]
